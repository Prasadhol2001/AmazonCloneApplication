...
import com.example.amazoncloneapplication.IntroActivity;
import com.example.amazoncloneapplication.R;
import com.example.amazoncloneapplication.ShowHistory;
...
//        setContentView(R.layout.activity_profile);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                // Check if the "email" child node exists
                DataSnapshot emailSnapshot = snapshot.child("email");
                if (emailSnapshot.exists()) {
                    emailId = emailSnapshot.getValue().toString();
                    ...
                    // Handle the case where "email" doesn't exist in the snapshot
                    progressDialog.dismiss();
                    // You might want to set default values or show an error message here
                }
            }
        ...
        profileImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (setImageUri != null) {
                    ...
                    String imgUri = "https://firebasestorage.googleapis.com/v0/b/clone-7e262.appspot.com/o/profilepic.jpg?alt=media&token=a90392ab-f47d-4ae5-b8b8-3d31a56d46d6";
