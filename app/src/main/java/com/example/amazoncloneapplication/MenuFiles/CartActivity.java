...
import com.example.amazoncloneapplication.PlaceOrderActivity;
import com.example.amazoncloneapplication.R;
import com.example.amazoncloneapplication.model.Cart;
import com.example.amazoncloneapplication.viewholder.CartViewHolder;
                    ...
                    protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull Cart model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setMessage("Do you want to remove this product form the cart?")
                                        .setCancelable(false)
