...
import com.example.amazoncloneapplication.model.AddProdModel;
import com.example.amazoncloneapplication.viewholder.RelatedProductsHolder;
...
public class ProductDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deatailsToolbar = findViewById(R.id.detailsToolbar);
        deatailsToolbar.setBackgroundResource(R.drawable.bg_color);
        ...
        if(id==1){
            ...
            productDesc.setText("Nike Air technology consists of pressurised air inside a tough yet flexible bag, andprovides more flexibility and spring without compromising structure");
            productImg.setImageResource(R.drawable.shoes1);
        }else if(id==2){
            uniqueId = uniqueId.replaceAll("\n"," ");
            productName.setText(intent.getStringExtra("name").replaceAll("\n"," "));
            productPrice.setText("₹9500");
            productDesc.setText("Nike Air is our iconic innovation that uses pressurized air in a durable,flexible membrane to provide lightweight cushioning. The air compresses on impact and thenimmediately returns to itsoriginal shape and volume, ready for the next impact.");
