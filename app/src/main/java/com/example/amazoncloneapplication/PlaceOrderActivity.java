...
public class PlaceOrderActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    private void check() {
        ...
        if (TextUtils.isEmpty(shipName.getText().toString())) {
            ...
            Toast.makeText(this, "Please enter your no.", Toast.LENGTH_SHORT).show();
    ...
    private void paymentFunc() {
        ...
        //set key id
        checkout.setKeyID("rzp_test_xI7aeIZZnLcaz3");
        //set image
        ...
        try {
            ...
            //put mobile no
            object.put("prefill.contact","9898989891");

            //put email
            object.put("prefill.email","androiduser@rzp.com");

            //open razorpay ckeckout activity
